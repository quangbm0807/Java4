...
public class UserDAO {
	...
	public List<User> findUsers(String fullname, String email, Boolean admin, int page, int size) {
		EntityManager em = JpaUtils.getEntityManager();
		try {
	...
	public long countUsers(String fullname, String email, Boolean admin) {
		EntityManager em = JpaUtils.getEntityManager();
		try {
