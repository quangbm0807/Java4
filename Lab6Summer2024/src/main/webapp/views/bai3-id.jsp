...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container">
        <h1 class="text-center mt-5 mb-4">Tìm Video Được Thích Theo ID Người Dùng</h1>
        
        <div class="search-container">
            <form action="/Lab6Summer2024/bai3-id" method="post">
                <div class="input-group mb-3">
                    <input name="id" type="text" class="form-control" placeholder="Nhập ID người dùng" aria-label="ID người dùng">
